...
interface LixirVaultInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "Deposit(address,address,uint256,uint256,uint256,uint256,uint256)": EventFragment;
    "Paused(address)": EventFragment;
    "Rebalance(int24,int24,int24,int24,uint24,uint256,uint256)": EventFragment;
...
export class LixirVault extends BaseContract {
  ...
  filters: {
    ...
    Rebalance(
      ...
      {
        mainTickLower: number;
        mainTickUpper: number;
